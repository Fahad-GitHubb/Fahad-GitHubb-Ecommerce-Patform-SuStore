    ...
    const blogs = [
        {
            ...
            description: 'Exploring the benefits of learning to code and how it can enhance your career.',
            author: 'Jane Doe',
        ...
        },
        {
            ...
            description: 'A deep dive into the popular JavaScript library for building user interfaces.',
            author: 'John Smith',
            publishingDate: '2023-04-15'
        },
        {
            ImageURL: '/images/placeholder.png',
            title: 'CSS Tips and Tricks',
            description: 'Learn some useful CSS techniques to improve your web design skills.',
            author: 'Alice Johnson',
            publishingDate: '2023-03-10'
        },
        {
            ImageURL: '/images/placeholder.png',
            title: 'The Future of Web Development',
            description: 'An overview of emerging trends in web development and technology.',
            author: 'Bob Brown',
            publishingDate: '2023-02-20'
        },
        {
            ImageURL: '/images/placeholder.png',
            title: 'JavaScript Best Practices',
            description: 'A collection of best practices for writing clean and efficient JavaScript code.',
            author: 'Emily White',
                ...
                {blogs.map((blog, index)=>{
                    return (
                        <div class="blog-card" key={index}>
                            <img src={blog.ImageURL} alt="" class="blog-card-image"/>
                            <div class="blog-card-meta-data">
